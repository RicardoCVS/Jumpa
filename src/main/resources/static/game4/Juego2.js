...
function encenderApagar() {
    ...
    if (imagenAbierto.src.match("Abierto1.gif")) {
      imagenAbierto.src = "Cerrado1.png";
     imagenAbierto.style.width= "120px";
     imagenAbierto.style.height= "70px";
    } else {
      imagenAbierto.src = "Abierto1.gif";
...
function encenderApagar1() {
    ...
    if (imagenAbierto.src.match("Abierto2.gif")) {
      imagenAbierto.src = "Cerrado2.png";
      imagenAbierto.style.width= "120px";
      imagenAbierto.style.height= "70px";
    } else {
      imagenAbierto.src = "Abierto2.gif";
      imagenAbierto.style.width= "130px";
      imagenAbierto.style.height= "130px";
    }
  }
function encenderApagar2() {
    ...
    if (imagenAbierto.src.match("Abierto3.gif")) {
      imagenAbierto.src = "Cerrado3.png";
      imagenAbierto.style.width= "120px";
      imagenAbierto.style.height= "70px";
    } else {
      imagenAbierto.src = "Abierto3.gif";
      imagenAbierto.style.width= "130px";
      imagenAbierto.style.height= "130px";
    }
  }
function encenderApagar3() {
    var imagenAbierto = document.getElementById("Abierto4");
    if (imagenAbierto.src.match("Abierto4.gif")) {
      imagenAbierto.src = "Cerrado4.png";
      imagenAbierto.style.width= "120px";
      imagenAbierto.style.height= "70px";
    } else {
      imagenAbierto.src = "Abierto4.gif";
      imagenAbierto.style.width= "130px";
      imagenAbierto.style.height= "130px";
    }
  }
  function encenderApagar4() {
    ...
    if (imagenAbierto.src.match("Abierto5.gif")) {
      imagenAbierto.src = "Cerrado5.png";
      imagenAbierto.style.width= "120px";
      imagenAbierto.style.height= "70px";
    } else {
      imagenAbierto.src = "Abierto5.gif";
      imagenAbierto.style.width= "130px";
      imagenAbierto.style.height= "130px";
    }  
  } 
  ...
  function cambiarImagen(){
    if (Abierto1.src.match("Abierto1.gif")){
      Abierto1.src = "Abierto1.gif";
  ...
  function cambiarImagen1(){
    if (Abierto2.src.match("Abierto2.gif")){
      Abierto2.src = "Abierto2.gif";
  ...
  function cambiarImagen2(){
    if (Abierto3.src.match("Abierto3.gif")){
      Abierto3.src = "Abierto3.gif";
  ...
  function cambiarImagen3(){
    if (Abierto4.src.match("Abierto4.gif")){
      Abierto4.src = "Abierto4.gif";
  ...
  function cambiarImagen4(){
    if (Abierto5.src.match("Abierto5.gif")){
      Abierto5.src = "Abierto5.gif";
